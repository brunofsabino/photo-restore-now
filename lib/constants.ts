...
export const SERVICE_OPTIONS: ServiceOption[] = [
  {
    id: 'restoration',
    name: 'Restore My Photo',
    description: 'Sharpen faded details and clean up light scratches. Best for photos that are mostly intact and already in color.',
    icon: '✨',
    priceMultiplier: 1.0,
  },
  {
    id: 'restoration-colorization',
    name: 'Restore & Add Color',
    description: 'Fix damage AND bring beautiful, natural colors to a black & white photo. The best choice for most old family photos.',
    icon: '🌈',
    priceMultiplier: 1.5,
    popular: true,
  },
  {
    id: 'deep-restoration',
    name: 'Repair Torn Photo',
    description: 'For photos with heavy tears, large creases, or white patches where pieces are missing. AI fills in the damage completely.',
    icon: '🩹',
    priceMultiplier: 2.0,
  },
];
...
export const PRICING_PACKAGES: PricingPackage[] = [
  {
    ...
    name: 'Single Photo',
    photoCount: 1,
    basePrice: 10, // $0.10 (TEMP TEST — change back to 1799)
    features: [
