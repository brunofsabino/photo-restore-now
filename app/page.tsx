          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <FadeIn direction="down" delay={0.1}>
                <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm text-primary px-4 py-2 rounded-full text-sm font-semibold mb-6 shadow-lg">
              ...
              <FadeIn direction="up" delay={0.4}>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link href={APP_ROUTES.PRICING}>
                    <Button size="lg" className="text-lg px-8 py-6 shadow-xl hover:shadow-2xl transition-shadow hover-lift">
                      <Sparkles className="mr-2 h-5 w-5" />
                      Restore Your Photos
                    </Button>
                  </Link>
                  <Link href="#examples">
                    <Button size="lg" variant="outline" className="text-lg px-8 py-6 border-2 bg-white/80 backdrop-blur-sm">
                      See Examples
                    </Button>
                  </Link>
                </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <FadeIn direction="up" delay={0.1}>
              <Card className="border-2 hover:border-primary transition-colors hover:shadow-xl hover-lift">
                <CardHeader>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="space-y-6">
              {[
                ...
                <FadeIn key={item.step} direction="left" delay={index * 0.1}>
        ...
        <div className="container relative z-10 mx-auto px-4">
          ...
          <ParallaxSection speed={0.2}>
            ...
            {[
              ...
              <FadeIn key={index} direction="up" delay={index * 0.1}>
                <Card className="border-2 hover:shadow-xl transition-shadow hover-lift">
                  <CardHeader>
